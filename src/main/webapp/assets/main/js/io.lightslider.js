	...
	return {
		...
		addArrows: function(slider){// slider jquery element
			if(slider.find(".io-ls-controls>.io-ls-arrows_container").length == 1){
				...
				if(slider.find(".io-ls-arrow_right").length == 0) slider.find(".io-ls-controls>.io-ls-arrows_container").append('<div class="io-ls-arrow_wrapper io-ls-arrow_right_wrapper"><div class="io-ls-arrow io-ls-arrow_right"><div class="io-ls-arrow_wrapper_right_body"><img src="./images/right-arrow.svg"></div></div>');
			}
		},
